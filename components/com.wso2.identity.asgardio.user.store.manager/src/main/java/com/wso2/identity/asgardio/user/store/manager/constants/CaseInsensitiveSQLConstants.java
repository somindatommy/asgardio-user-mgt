...
public class CaseInsensitiveSQLConstants {
    ...
    public static final String COUNT_ASSOCIATIONS_FOR_USERS_SQL = "SELECT COUNT(ASG_ASSOCIATION) AS RESULT FROM " +
            "ASG_USER_TENANT_ASC  WHERE ASG_USER_UUID IN (?) AND ASG_TENANT_UUID = ?";
