...
public class CaseInsensitiveSQLConstants {
    ...
    public static final String GET_USER_PROPS_FOR_PROFILE_WITH_ID_SQL =
            "SELECT UM_ATTR_NAME, UM_ATTR_VALUE FROM UM_USER_ATTRIBUTE, UM_USER " +
                    "WHERE UM_USER.UM_ID = UM_USER_ATTRIBUTE.UM_USER_ID AND UM_USER.UM_USER_ID=? AND UM_PROFILE_ID=?";
    public static final String GET_USERS_PROPS_FOR_PROFILE_WITH_ID_SQL =
            "SELECT UM_USER.UM_USER_ID, UM_ATTR_NAME, UM_ATTR_VALUE FROM UM_USER_ATTRIBUTE, UM_USER " +
                    "WHERE UM_USER.UM_ID = UM_USER_ATTRIBUTE.UM_USER_ID AND UM_USER.UM_USER_ID IN (?) " +
                    "AND UM_PROFILE_ID=?";
    ...
    public static final String SELECT_USER_NAME_CASE_INSENSITIVE_SQL =
            "SELECT UM_USER_ID, UM_USER_NAME, UM_USER_PASSWORD, UM_SALT_VALUE, UM_REQUIRE_CHANGE, " +
                    "UM_CHANGED_TIME FROM UM_USER WHERE LOWER(UM_USER_NAME)=LOWER(?)";
